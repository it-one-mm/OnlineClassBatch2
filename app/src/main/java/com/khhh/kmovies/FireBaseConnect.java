...
public class FireBaseConnect {
    ...
    public void getMovies(String categoryName)
    {

        movieRef.whereEqualTo("movieCategory",categoryName).addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
            public void onEvent(@Nullable QuerySnapshot queryDocumentSnapshots, @Nullable FirebaseFirestoreException e) {
                ArrayList<MoiveModel>moiveModels=new ArrayList<MoiveModel>();
                moiveModels.clear();
               ...
               MovieFragment.recyclerView.setLayoutManager(gm);
                MovieFragment.progressBar.setVisibility(View.GONE);
            }
        });
    }
